...
const API_URL = "http://localhost:3001/activities/multiplechoice";
...
const CreateMultipleChoiceActivity = () => {
  ...
  const handleSubmit = async (values: FormValues) => {
    ...
    try {
      ...
      if (response.status === 201) {
        alert("Atividade de múltipla escolha criada com sucesso!");
  ...
  return (
    <div className="min-h-screen bg-green-100 dark:bg-gray-900 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h2 className="text-2xl font-bold mb-6 text-center">Criar Atividade - Múltipla Escolha</h2>
...
export default CreateMultipleChoiceActivity;